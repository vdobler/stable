...
set title "{/*1.3 Stable Sorting}\nMergeSort using SymMerge using BlockSwap" 
...
set y2label "{/*1.25 # Less}" 
set y2label  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set yrange [ 100.000 : 1.00000e+12 ] noreverse nowriteback
set y2range [ 100.000 : 1.00000e+12 ] noreverse nowriteback
set zlabel "" 
...
c = 1.16239563551843
d = 1.001
fit [1e4:] a*x*log(x) "swaps" using 2:6:($6/1000) via a
fit [1e4:] b*(x**c) "swaps" using 2:4:($4/1000) via b,c
ts = sprintf("fit: %.1f n^{/*1.1 %.2f}", b,c)
tc = sprintf("fit: %.2f n log n", a)
set out "plot.png"
set term pngcairo enhanced color solid font "Helvetica" fontscale 0.95 size 800,600

plot "swaps" u 2:4 ax x1y1 tit "calls to Swap",  b*(x**c) tit ts, "swaps" u 2:6 ax x1y2 tit "calls to Less", a*x*log(x) ax x1y2 tit tc
